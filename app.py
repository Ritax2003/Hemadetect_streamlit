...
if __name__ == '__main__':
    with st.sidebar:
        selected = option_menu('Blood Cancer Predictor',
                          ...
                          default_index=0)
if selected =="HemaDetect - Blood Cancer Prediction":
...
if selected == "About Us":
        ...
        st.markdown("<p style='text-align: center;'>Patrika Chatterjee</p>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center;'>Titli Paul</p>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center;'>Sumit Mitra</p>", unsafe_allow_html=True)
        st.markdown("____")
